...
import { Shield, Zap, Download, FileVideo, Lock, Clock, Gauge, Globe, Music, Settings2 } from 'lucide-react';
...
const features = [
  ...
  },
  {
    ...
    description: 'Extract audio from YouTube and 1000+ sites as high-quality MP3 or M4A with a single click.',
  },
  {
    icon: Settings2,
    title: 'Quality Selection',
    description: 'Choose your preferred quality — from 4K Ultra HD to bandwidth-saving 360p with detailed format info.',
  },
  {
    icon: Shield,
  ...
  },
  {
    icon: Zap,
    title: 'Fast & Reliable',
    description: 'Server-side processing with streaming downloads, rotating proxies, and automatic retry for reliability.',
  },
  {
    icon: FileVideo,
    title: 'Multiple Formats',
    description: 'Support for 10+ video formats and 6 audio formats including MP3, M4A, AAC, OPUS, and FLAC.',
  },
  {
    icon: Lock,
    title: 'Privacy First',
  ...
  },
  {
    ...
    description: 'YouTube, Vimeo, TikTok, Twitter/X, Instagram, Reddit, and hundreds more via yt-dlp integration.',
  },
];
      ...
      <div className="mx-auto max-w-[1200px] px-4 sm:px-6">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-xl mx-auto">
            A professional, privacy-respecting tool designed for downloading video and extracting audio from any source.
          </p>
        </motion.div>
          ...
          {features?.map?.((feature: any, idx: number) => {
            ...
            return (
              <motion.div
                ...
                className="group rounded-xl bg-card border border-border/50 p-5 hover:border-primary/20 transition-all cursor-default gradient-border-hover"
