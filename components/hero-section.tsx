    ...
    <>
      <section id="hero" className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 -z-10">
          ...
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[600px] rounded-full bg-gradient-to-b from-primary/8 to-transparent blur-3xl" />
        </div>
        ...
        <div className="mx-auto max-w-[1200px] px-4 sm:px-6 pt-16 pb-12 sm:pt-24 sm:pb-16">
          ...
          >
            ...
            <p className="text-muted-foreground text-base sm:text-lg max-w-2xl mx-auto">
              Paste any direct video file link to analyze and download. Supports MP4, WebM, MOV, and more.
            </p>
          </motion.div>
          ...
          >
            <div className="relative rounded-xl bg-card p-1.5" style={{ boxShadow: 'var(--shadow-lg)' }}>
